...
AI: 根据天气数据，你当前所在的位置（洛杉矶）今天天气晴朗，气温16°C，
    体感温度也是16°C，湿度78%，吹南偏西风，风速7km/h。整体感觉舒适！

You: DeepSeek-V3 什么时候发布的？

AI: [自动调用 search_web 搜索 → ]
    根据搜索结果，DeepSeek-V3 于 2024年12月26日正式发布。
    模型架构为自研 MoE，总参数量 671B，激活参数 37B...
```
...
| `TAVILY_API_KEY` | — | Tavily 搜索 API Key（chat 路径） |
...
| chat | 关闭 | 工具调用 + thinking 有兼容问题，显式关闭 |
